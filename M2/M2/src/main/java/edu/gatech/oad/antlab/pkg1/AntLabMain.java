 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Clayton Lawrence");
		  toPrint += p1.toString("clawrence8");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Naud Ghebre");
		  toPrint += p2.toString("nghebre3");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Julia");
		  toPrint += p3.toString("jneuman3");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Hannah");
                  toPrint += p4.toString("halequin3");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Chez Browne");
                  toPrint += p5.toString("cbrowne7");
    ...
    /**
     * @param args The string taken in  
